...
| nach            | Der Zielknotenarm beim Zählen einer Verkehrsbeziehung. Handelt es sich um eine Zählung welche keine Verkehrsbeziehung mit einem Quell- und Zielknotenarm darstellt, so ist dieses Feld leer zu lassen. |
| Strassenseite   | Die Himmelsrichtung als N, O, S, W, NO, NW, SO oder SW für QjS und FjS; ansonsten wird das Feld leer gelassen.                                                                                         |
| Richtung        | EIN oder AUS für FjS und N, O, S, W, NO, NW, SO oder SW für Querung (Qu), ansonsten leer                                                                                                                                                                                                    |
