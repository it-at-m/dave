...
| Verkehrsbeziehung | Eine Zählung kann je Knotenarm bis zu acht Fahrbeziehungen besitzen. Eine Fahrbeziehung beginnt bei einem Knotenarm und endet bei einem anderen Knotenarm oder bei sich selbst (U-Turn). Zusätzlich kann zwischen der Strassenseite unterschieden werden, um den fahrbahnseitigen Querschnittsverkehr persistieren zu können. |
